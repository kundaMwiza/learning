...
unsigned int SmartETL::_process_question(question_map &data, unsigned int id, std::string &line_str, delimiter_type d)
{
...
unsigned int SmartETL::_process_category(category_map &data, unsigned int id, std::string &line_str, delimiter_type d)
{
...
unsigned int SmartETL::_process_resources(resource_map &data, unsigned int id, std::istream &input_file, delimiter_type d)
{
    std::string line_str;
